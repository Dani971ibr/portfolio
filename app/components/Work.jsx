...
const Work = ({isDarkMode}) => {
  return (
    ...
    transition={{duration: 0.5, delay: 0.7}}
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Welcome to my web development Portfolio! Explor a collection of projects showcasing my exoertise in fron-end development
      </motion.p>
